...
function view_page_view($link)    {
   ...
   global $n_record,$i,$links;
	...
	echo "<a href=\"#\" style=\"padding:0px 5px; text-align:center; font-weight:bold; font-size:14px; text-decoration:none; margin:0px 10px; border-right:1px solid #f0f0f0; width:200px;\">Trang ";
	echo $_GET['view']== ''?1:$_GET['view'];
	echo '/'.num_page().'</a>';
	echo "&nbsp;<a href=\"$link-1.html\" style=".($i==$_GET['view']?'color:#FF0000;padding:0px 5px; font-weight:bold; font-size:14px; text-align:center; text-decoration:none; margin:0px 10px;':'font-weight:bold; font-size:14px; color:#008000; padding:0px 5px; text-align:center; text-decoration:none; margin:0px 10px;').">"."Đầu"."</a>&nbsp;&gt;";
    ...
    {
		if($i < $_GET['view']+5 && $i > $_GET['view']-5) {
		echo "&nbsp;<a href=\"$link-$i.html\" style=".($i==$_GET['view']?'color:#FF0000;padding:0px 5px; font-weight:bold; font-size:14px; text-align:center; text-decoration:none; margin:0px 10px;':'font-weight:bold; font-size:14px; color:#008000;padding:0px 5px; text-align:center; text-decoration:none; margin:0px 10px;').">".$i."</a>&nbsp;&gt;";
		}
	}
		if(num_page()>=5) echo '...';
			$k=$i-1;
			echo "&nbsp;<a href=\"$link-$k.html\" style=".($i==$_GET['view']?'color:#FF0000;padding:0px 5px; text-align:center; text-decoration:none; margin:0px 10px; font-weight:bold; font-size:14px;':'font-weight:bold; font-size:14px; color:#008000;padding:0px 5px; text-align:center; text-decoration:none; margin:0px 10px;')."  >"."Cuối"."</a>&nbsp;";
    }
	}
 ?>