...
<?  
  if($_POST['UpdatePass']) {
				 ...
				 if(mysql_num_rows(mysql_query("SELECT * FROM ".admin." WHERE password='".text(md5(text($_POST['passold'])))."'"))>0)   {
				 
					mysql_query("UPDATE ".admin." SET password='".text(md5(text($_POST['passnew'])))."'
