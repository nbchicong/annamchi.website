...
<form action="" method="post" enctype="multipart/form-data" >
 <tr  id="tieude"><td  colspan="2"  height="30">&nbsp;&nbsp;&nbsp;<strong>Thêm Thành viên </strong>  </td>  </tr>
  ...
  <tr>
    <td width="19%" class="height_row"><div align="right">Số ĐT &nbsp;</div></td>
    <td width="81%" class="height_row"><label>
      <input name="phone" type="text" class="input_text" id="phone" />
    </label></td>
  </tr>
  <tr>
...
<form method="post" action=""  enctype="multipart/form-data">
  ...
  <tr>
    <td width="19%" class="height_row"><div align="right">Số ĐT &nbsp;</div></td>
    <td width="81%" class="height_row"><label>
      <input name="phone" type="text" class="input_text" id="phone" value="0<?=$row['phone']?>" />
    </label></td>
  </tr>
  <tr>
    <td class="height_row"><div align="right">Loại &nbsp;</div></td>
    <td class="height_row">
	<select name="kind" class="input_text" >
		<option value="1" <? echo $row['kind']=='1'?'Selected':''?>>Yahoo</option>
		<option value="2" <? echo $row['kind']=='2'?'Selected':''?>>Skype</option>
	</select></td>
  </tr> 
  <tr>
    <td>&nbsp;</td>
...
<tr id="tieude">
      <td width="5%" height="27" ><div align="center">#ID</div></td>
        ...
        <td width="8%" ><div align="center">Loại</div></td>
        <td width="7%" ><div align="center">Số TT </div></td>
		<td width="15%" ><div align="center">Số ĐT </div></td>
		 <td width="10%" ><div align="center">Sửa </div></td>
      <td width="20%" ><div align="center">Trạng Thái</div></td>        
</tr>
  <?
	     $p=10;
...
?>	  
	  <tr id="show">
		...
		<td   ><div align="center">
		<? echo $row['kind']=='1'?'Yahoo':'Skype';?></div></td>
		<td  ><div align="center"><?=$row['stt']?></div></td>
		<td  ><div align="center">0<?=$row['phone']?></div></td>
