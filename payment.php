...
function showCartb() {
	...
	if ($cart) {
		...
		$output[] = ' Tổng đơn giá: '.number_format($total*$explode[0],0,",",".").' '.$explode[1].'
';                   $output[] = '
<font color=#FF0000> Tên khách hàng:'.$_POST['fullname'].'';                                $output[] = '
<font color=#FF0000> Địa chỉ:'.$_POST['address'].'';                                        $output[] = '
<font color=#FF0000> Điện thoại:'.$_POST['telephone'].'';  
